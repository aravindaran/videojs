...
class videojsXBlock(XBlock):
    ...
    def student_view(self, context=None):
        ...
        frag.add_css(self.load_resource("static/css/valiant360.css"))
        frag.add_javascript(self.load_resource("static/js/three.min.js"))
        frag.add_javascript(self.load_resource("static/js/jquery.valiant360.js"))
